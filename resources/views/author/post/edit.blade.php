...
<section class="content">
	<div class="container-fluid">
		<div class="block-header">
			<a class="btn btn-success waves-effect" href="{{ route('author.post.index') }}">Back</a>
		</div>
					...
					<div class="card">
						...
						<div class="body">
							...
							<div class="form-group ">
								<div class="form-line">
									<input type="text" name="title" id="title" class="form-control" placeholder="Enter your post title" value="{{ $post->title }}">
								</div>
