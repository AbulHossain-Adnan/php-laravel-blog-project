				...
				<div class="body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="profile_with_icon_title">
							<form method="post" action="{{ route('author.settings.update',Auth::id()) }}" enctype="multipart/form-data">
								@method('PUT')
								@csrf
						...
						<div role="tabpanel" class="tab-pane fade" id="password_with_icon_title">
							<form method="post" action="{{ route('author.settings.update-password',Auth::id()) }}">
								@method('PUT')
								@csrf
