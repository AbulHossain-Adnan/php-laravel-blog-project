...
<section class="content">
	<div class="container-fluid">
		<div class="block-header">
			...
			<a class="btn btn-primary waves-effect mb-3" href="{{ route('admin.post.create') }}">
									...
									<tr>
										...
										<td>
											...
											<div class="btn-group">
												...
												<a class="btn btn-sm btn-primary waves-effect" href="{{ route('admin.post.show',$post->id) }}">
													<i class="material-icons">visibility</i>
												</a>
												<a class="btn btn-sm waves-effect" href="{{ route('admin.post.edit',$post->id) }}">
