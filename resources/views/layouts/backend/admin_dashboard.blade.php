...
<body class="theme-blue">
    ...
    <!-- #END# Search Bar -->
    <!-- Top Bar -->
    @include('layouts.backend.admin_nav')
    <!-- #Top Bar -->
    {{-- left and right side bar start--}}

    @include('layouts.backend.left_right_sidebar')

    {{-- left and right side bar end--}}
    ...
    {{-- <script src="{{ asset('assets/backend') }}/plugins/sweetalert/dialogue.js"></script> --}}
